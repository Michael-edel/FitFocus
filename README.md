...
| `npm run test:unit` | пройдено, 59 файлов / 238 тестов |
| `npm run test:e2e -- e2e/pwa-shell.spec.ts e2e/onboarding.spec.ts e2e/push-settings.spec.ts` | не запущено: в окружении отсутствуют бинарники Playwright Chromium/Firefox/WebKit |
...
- README синхронизирован с текущими проверками: 20 миграций, 30 таблиц, 59 unit-файлов и 238 тестов.
...
| `npm run typecheck` | пройдено |
| `npm run build` | пройдено |
| `npm run test:e2e -- e2e/pwa-shell.spec.ts e2e/onboarding.spec.ts e2e/push-settings.spec.ts` | не выполнено: отсутствуют браузеры Playwright |
